...
let replicaSetName = vcap_services[mongodb_service_name][0].credentials.replicaSetName;
let db = vcap_services[mongodb_service_name][0].credentials.uri + '?replicaSet=' + replicaSetName;
